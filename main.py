...
check_bus = BusCheck(robobo, [go_ahead, turn_qr, stop_bus], params, stop_bus)

emergency_tap = EmergencyTap(robobo, [go_ahead, turn_qr, stop_bus, check_bus], params)

# Se crea una Lista con los comportamientos (2 en este ejemplo)
threads = [go_ahead, turn_qr, stop_bus, check_bus, emergency_tap]
